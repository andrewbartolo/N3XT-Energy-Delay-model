...
################################################################################
        ...
        # Commented out b/c this field doesn't exist for MD1 (N3XT) mem model
        ...
        if True:
            ...
            memLeakageEnergy = tc.memLeakagePower * tc.nMemControllers * duration
            eMemory = sumMemPreLeakageEnergy + memLeakageEnergy # plus tc.perChannelMemLeakageEnergy * tc.nControllers
        else:
